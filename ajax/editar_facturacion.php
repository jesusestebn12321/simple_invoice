...
$insert_detalle_factura=mysqli_query($con, "INSERT INTO detalle_factura (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");
...
$getid = mysqli_query($con, "SELECT * FROM detalle_factura WHERE id_detalle='$id_detalle'");
...
<tr>
	<td class='text-right' colspan=5>TOTAL DESCUENTO (<?php echo $descuento;?>)% <?php echo $simbolo_moneda;?></td>
