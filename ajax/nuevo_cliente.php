<?php
	...
	if (empty($_POST['RUC'])) {
		...
		$sql="INSERT INTO clientes (RUC_cliente, nombre_cliente, ciudad_cliente, telefono_cliente, direccion_cliente,  date_added) VALUES ('$RUC','$nombre','$ciudad','$telefono','$direccion','$date_added')";
