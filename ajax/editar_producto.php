...
/*LISTO*/
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', descripcion_producto='".$descripcion."',proveedor_producto='".$proveedor."',id_categoria='".$categoria."', cantidad='".$cantidad."', precio_producto='".$precio_venta."' WHERE id_producto='".$id_producto."'";
