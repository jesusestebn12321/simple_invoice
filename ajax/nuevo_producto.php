...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, descripcion_producto,proveedor_producto,date_added, precio_producto, cantidad, id_categoria) VALUES ('$codigo','$nombre','$descripcion','$proveedor','$date_added','$precio_venta', '$cantidad','$id_categoria')";
