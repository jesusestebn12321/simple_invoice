<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET RUC_cliente='".$RUC."', nombre_cliente='".$nombre."', ciudad_cliente='".$ciudad."', telefono_cliente='".$telefono."',  direccion_cliente='".$direccion."' WHERE id_cliente='".$id_cliente."'";
