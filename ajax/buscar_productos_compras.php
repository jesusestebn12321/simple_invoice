			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<input type="text" class="form-control" style="text-align:right" id="cantidad_<?php echo $id_producto; ?>"  value="0" >
						</div>
					    </td>
						...
						<td class='text-center'><a class='btn btn-default'href="#" onclick="agregar('<?php echo $id_producto ?>','<?php echo $cantidad; ?>')"><i class="glyphicon glyphicon-shopping-cart"></i></a></td> 
