 ...
 <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 15%;text-align:left;" class='midnight-blue'>DESCRIPCION</th>
...
?>
        ...
        <tr>
            <td colspan="6" style="widtd: 100%; text-align: right;">SUBTOTAL <?php echo $simbolo_moneda;?> </td>
            <td style="widtd: 15%; text-align: right;"> <?php echo number_format($subtotal,2);?></td>
        </tr>
		<tr>
            <td colspan="6" style="widtd: 100%; text-align: right;">IVA (<?php echo $impuesto;?>)% <?php echo $simbolo_moneda;?> </td>
        ...
        <tr>
            <td colspan="6" style="widtd: 100%; text-align: right;">TOTAL  <?php echo $simbolo_moneda;?> </td>
