		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-8">
				<textarea class="form-control" id="mod_proveedor" name="mod_proveedor" placeholder="Proveedor del producto" required maxlength="255" ></textarea>
            ...
            <div class="form-group">
               ...
               <div class="form-group">
				...
				<div class="col-sm-8">
				 <input type="number" class="form-control" id="mod_cantidad" name="mod_cantidad" placeholder="cantidad del producto" required pattern="^[0-9]{0>100}(\.[0-9]{99<100})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
